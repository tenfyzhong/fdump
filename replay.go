...
type PreReplayHook func(conn net.Conn, models []*Record) error

// PreSendHook will call before send packet
type PreSendHook func(conn net.Conn, model *Record) error
...
type PostSendHook func(conn net.Conn, model *Record) error
